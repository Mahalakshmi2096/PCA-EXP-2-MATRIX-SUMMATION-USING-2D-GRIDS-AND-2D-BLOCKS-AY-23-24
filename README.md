...
<img width="1092" height="358" alt="image" src="https://github.com/user-attachments/assets/fd52864a-daf4-42f7-8738-c1dd795bc777" />

## RESULT:
The host took 0.903894 seconds to complete it’s computation, while the GPU outperforms the host and completes the computation in 0.116481 seconds. Therefore, float variables in the GPU will result in the best possible result. Thus, matrix summation using 2D grids and 2D blocks has been performed successfully.
